...
const Banner = () => {
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat'>
            ...
            <div className='text-center mb-6'>
                ...
                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>Transform your tech learnings with our platform. Write blog posts, learn and enhance your knowledge.</p>
            </div>
            ...
            <div className='flex items-center mt-8 gap-4 text-gray-600 mx-auto'>
